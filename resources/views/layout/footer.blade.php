...
<footer>
  ...
  <section class="link-footer2">
    <ul>
      ...
      <form>
        <input class="btn btn-outline-dark"type="submit" onclick="switch_style('default');return false;" name="theme" value="default Theme" id="default">
        <input class="btn btn-outline-dark" type="submit" onclick="switch_style('dark');return false;" name="theme" value="Dark Theme" id="black">
      </form>
